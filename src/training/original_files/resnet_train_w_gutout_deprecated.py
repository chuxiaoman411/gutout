...
# GutOut arguments
parser.add_argument(
    "--gutout", action="store_true", default=True, help="apply gutout"  # was False
)
parser.add_argument(
    "--model_path",
    default=r"cifar10_resnet18_acc0.7985_.pth",  # originally: 'cifar10_resnet18_acc0.7985_.pth'
...
for epoch in range(args.epochs):
    ...
    if is_best:
        torch.save(
            model.state_dict(),
            os.path.join(experiment_dir, "checkpoints/" + experiment_id + "_best.pth"),
        )
